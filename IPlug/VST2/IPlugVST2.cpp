...
#ifndef OS_LINUX
        // NOTE: Careful in removing this ifndef
        // In my testing, removing this results in gui going away on VST2 _and_ a segfault.
        // You might think that this is fine because it works in other platforms but for whatever reason
        // this is not safe on linux. YMMV because I don't know what is going on here.
